...
export class SliderComponent implements OnInit, OnDestroy, AfterViewInit {
  ...
  slides = [
    {
      type: 'image',
      image: 'assets/images/carousel/slide6.png',
      title: 'Empowering Futures: ',
      subTitle: 'Finance Education For All',
      id: 'education-access',
      description:
        "We've built a supportive learning environment, enriching the lives of students — especially young women — and strengthening the leadership of women educators.",
    },
    // {
    //   type: 'video',
    //   videoId: 'I0iGNUXRLS4',
